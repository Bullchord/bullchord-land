...
const Docs = () => {
  return (
    ...
    <p>Bullchord is a powerful music platform for musicians to create an empowering experience for listeners. Every expert of the platform is designed from the ground up to support better music scalin
    </p>
    </div>
    </>
  )
